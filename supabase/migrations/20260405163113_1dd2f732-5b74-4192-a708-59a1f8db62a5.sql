...
-- Messages policies: conversation participants can read/send
...
-- Agreement templates: all authenticated can read active ones
CREATE POLICY "Read active templates" ON public.agreement_templates
  FOR SELECT TO authenticated
  USING (is_active = true);

-- Agreements: creator and deal participants
