...
CREATE INDEX IF NOT EXISTS idx_deal_room_activity_created_at ON deal_room_activity(created_at);
...
DROP POLICY IF EXISTS deal_room_activity_view ON deal_room_activity;
...
DROP POLICY IF EXISTS deal_room_activity_insert ON deal_room_activity;
